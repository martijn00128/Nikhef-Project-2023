...
//----------------------------------------Material--------------------------------------------------
	...
	G4double energyAIR[2] = {1.239841939*eV/0.9,1.239841939*eV/0.2};
...
//----------------------------------------World-------------------------------------------------
	...
	G4Box *solidWorld = new G4Box("solidWorld",2.5*m,2.5*m,2.5*m); //Half length

	//for interaction
	G4LogicalVolume *logic_World = new G4LogicalVolume(solidWorld,worldMaterial,"logicWorld");
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~WCD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	...
	G4VPhysicalVolume *phys_Metal_Box = new G4PVPlacement(0, G4ThreeVector(0., 0., 0.),logical_Metal_Box,"phys_Metal_Box",logic_World,false,0,false);
...
//+++++++++++++++++++++++++++++++++++++++++Scintillator++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	G4VPhysicalVolume *phys_Sci1 = new G4PVPlacement(0,G4ThreeVector(0,0,0.4*m),logical_Sci1,"phys_Sci1",logic_World,false,0,true);
	...
	G4VPhysicalVolume *phys_Sci2 = new G4PVPlacement(0,G4ThreeVector(0,0,-0.4*m),logical_Sci2,"phys_Sci2",logic_World,false,0,false);
